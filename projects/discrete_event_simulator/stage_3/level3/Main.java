...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        EventHandler eventHandler = new EventHandler(seed, numOfHumanServers, numOfSelfCheckoutCounters, queueCapacity, numOfCustomers, arrivalRate, serviceRate, restingRate, restingProbability);
