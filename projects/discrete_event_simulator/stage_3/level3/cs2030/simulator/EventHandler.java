...
public class EventHandler {
   ...
   * Constructor.
   */
  public EventHandler(int seed, int numOfHumanServers, int numOfSelfCheckoutCounters, int queueCapacity, int numOfCustomers, double arrivalRate, double serviceRate, double restingRate, double restingProbability) {
    eventQueue = new PriorityQueue<>();
    serverList = new ArrayList<>();
    rng = new RandomGenerator(seed, arrivalRate, serviceRate, restingRate);
    stats = new Statistics();
    createServers(numOfHumanServers, queueCapacity, restingProbability, numOfSelfCheckoutCounters);
   ...
   */
  void createServers(int numOfHumanServers, int queueCapacity, double restingProbability, int numOfSelfCheckoutCounters) {
